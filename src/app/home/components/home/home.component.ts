...
export class HomeComponent implements OnInit {
  ...
  imageShirts:string = `../../../../assets/images/t-shirts.jpg`;
  imageSneakers:string = `../../../../assets/images/sneakers.jpg`;
  imageWatches:string = `../../../../assets/images/watches.jpg`;
  imageBags:string = `../../../../assets/images/bags.jpg`; 
