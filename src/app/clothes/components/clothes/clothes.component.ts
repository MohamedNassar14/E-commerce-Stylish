...
export class ClothesComponent implements OnInit {
  ...
  constructor(private _ClothesService:ClothesService, private _SharedService:SharedService, private toast:ToastrService) {}
  ...
  {
    this.spinner;
    this._ClothesService.getAllClothes('mens-shirts').subscribe({
      next:(data)=> 
      {
        this.spinner = true;
        this.menClothes = data.products;
      }
    })
  }
  //Get Women clothes
  ...
  {
    this.spinner;
    this._ClothesService.getAllClothes('womens-dresses').subscribe({
      next:(data)=> 
      {
        this.spinner = true;
        this.womenClothes = data.products;
      }
    })
  }
  //Add product to cart
